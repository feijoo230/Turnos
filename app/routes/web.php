...
Route::get('historia', 'frontend\FrontendController@historia')->name('historia');
Route::get('proyectos', 'frontend\FrontendController@proyectos')->name('proyectos');
Route::get('investigacion', 'frontend\FrontendController@investigacion')->name('investigacion');
Route::get('instalaciones', 'frontend\FrontendController@instalaciones')->name('instalaciones');
Route::get('equipo', 'frontend\FrontendController@equipo')->name('equipo');
